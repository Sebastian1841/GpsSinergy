...
- `useReportEventRuleFormDraft.js`: estado editable del formulario de reglas, incluyendo condiciones, notificaciones, calendario, activacion y alcance por grupos.
- `useReportBuilder.js`: estado de formulario para crear/editar plantillas.
  ...
  columnas obligatorias, widgets, comportamiento especial y opciones de salida.
  ...
  resumen de `Vista` y `Salida` deben derivarse desde este borrador y no crear
  estados locales paralelos.

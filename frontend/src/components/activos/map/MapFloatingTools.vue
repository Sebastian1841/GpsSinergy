<template>
  <div @click.stop>
    ...
    >
      ...
      <span class="pointer-events-none absolute left-[48px] top-1/2 hidden -translate-y-1/2 whitespace-nowrap rounded-md bg-[#102372] px-2 py-1 text-[10px] font-black text-white shadow-lg group-hover:block">
        Herramientas
      </span>
    </button>
    ...
    >
      ...
      >
        ...
        <span class="pointer-events-none absolute left-[46px] top-1/2 hidden -translate-y-1/2 whitespace-nowrap rounded-md bg-[#102372] px-2 py-1 text-[10px] font-black text-white shadow-lg group-hover:block">
          Geocerca
        </span>
      </button>
